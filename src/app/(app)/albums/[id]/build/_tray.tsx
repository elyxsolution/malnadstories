...
/**
 * The album's photo tray. Each thumbnail is draggable onto a layout slot, can be
 * opened in the editor, or deleted. Placed photos are badged + dimmed (a photo is
 * placed at most once). Delete hits the existing DELETE /api/photos/:id route and
 * tells the parent to drop it from state (and any slot it occupied).
 */
